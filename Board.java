...
public class Board {
    ...
    public ArrayList<Integer> countConsecutiveRowsIdx(int startrow, int startcol, Player player) {
        int cnt = 0;
        int maxCnt = 0;
        byte playerMaxOrmin;
        int stopi = 0;
        ...
        for (int i = 0; i < getCols() - startcol; i++) {
            if (board[startrow][startcol + i] == playerMaxOrmin) {
                cnt++;
            } else {
                cnt = 0;
            }
    ...
    public ArrayList<Integer> countConsecutiveColsIdx(int startrow, int startcol, Player player) {
        int cnt = 0;
        int maxCnt = 0;
        int stopi = 0;
        byte playerMaxOrmin;
        ...
        for (int i = 0; i < getRows() - startrow; i++) {
            if (board[startrow + i][startcol] == playerMaxOrmin) {
                cnt++;
            } else {
                cnt = 0;
            }
    ...
    public ArrayList<Integer> countConsecutiveDiagonalDownIdx(int startrow, int startcol, Player player) {
        int cnt = 0;
        int maxCnt = 0;
        int stopi = 0;
        byte playerMaxOrmin;
        ...
        for (int i = 0; i <= startrow && i < getCols() - startcol; i++) {
            if (board[startrow - i][startcol + i] == playerMaxOrmin) {
                cnt++;
            } else {
                cnt = 0;
            }
    ...
    public ArrayList<Integer> countConsecutiveDiagonalUpIdx(int startrow, int startcol, Player player) {
        int cnt = 0;
        int maxCnt = 0;
        int stopi = 0;
        byte playerMaxOrmin;
        ...
        for (int i = 0; i < getCols() - startcol && i < getRows() - startrow; i++) {
            if (board[startrow + i][startcol + i] == playerMaxOrmin) {
                cnt++;
            } else {
                cnt = 0;
    ...
    public int findEmptySpacesInSameRow(int startrow, int startcol, int maxCnt, int stopi) {
        int zeros =0;
        if(startcol + stopi + 1 < getCols() && board[startrow][startcol + stopi] == 0) {
            zeros++;
        }
        if(startcol + stopi - maxCnt- 1 < getCols() && startcol + stopi - maxCnt- 1 >= 0 &&
                board[startrow][startcol + stopi - maxCnt- 1] == 0) {
            zeros++;
        }
        return zeros;
    }

    public int findEmptySpacesInSameDiagUp(int startrow, int startcol, int maxCnt, int stopi) {
        int zeros =0;
        if(startrow + stopi < getRows() && startcol + stopi < getCols() && board[startrow + stopi][startcol + stopi] == 0) {
            zeros++;
        }
        if(startrow + stopi - maxCnt- 1 < getCols() &&  startcol + stopi - maxCnt- 1 < getRows() && startrow + stopi - maxCnt- 1 >= 0 &&
                startcol + stopi - maxCnt- 1 >= 0 && board[startrow + stopi - maxCnt- 1][startcol + stopi - maxCnt- 1] == 0) {
            zeros++;
        }
        return zeros;
    }
    public int findEmptySpacesInSameDiagDown(int startrow, int startcol, int maxCnt, int stopi) {
        int zeros =0;
        if(startrow + stopi < getRows() && startcol - stopi >= 0 && board[startrow + stopi][startcol - stopi] == 0) {
            zeros++;
        }
        if(startrow + stopi - maxCnt- 1 < getRows() && startcol - stopi + maxCnt + 1 < getCols() && startrow + stopi - maxCnt- 1 >= 0 &&
                startcol - stopi + maxCnt + 1 >= 0 && board[startrow + stopi - maxCnt- 1][startcol - stopi + maxCnt + 1] == 0) {
            zeros++;
        }
        return zeros;
